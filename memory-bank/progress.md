...
### Temel İşlevsellik
- [x] Vite + React + TypeScript proje kurulumu
- [x] Tailwind CSS yapılandırması
- [x] Dark/Light tema desteği
- [x] Çoklu dil desteği (İngilizce/Türkçe)
- [x] Çoklu para birimi desteği (USD, EUR, TRY)

### Dashboard
- [x] Finansal özet kartları (bakiye, gelir, gider)
- [x] Hızlı istatistikler (ort. gider, en çok harcama, aktif abonelikler)
- [x] Kategori dağılımı pasta grafiği
- [x] Son işlemler tablosu
- [x] Responsive tasarım

### İşlem Yönetimi
- [x] İşlem ekleme/düzenleme/silme modal
- [x] Sürükle-bırak ile sıralama (dnd-kit)
- [x] Liste ve Grid görünüm modu
